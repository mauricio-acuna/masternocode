...
- Portada
- Creditos y licencia
- Prefacio: por que code/no-code ya no alcanza
- Como usar esta obra

## Parte I - La pregunta equivocada
...
1.4 El nuevo valor del developer
...
2.3 Shopify y Modern Dropship como destino
2.4 La capa de sincronizacion que faltaba
2.5 Lo que vuelve dificil el problema

## Parte II - Tres enfoques
...
5.3 Agentes con contexto
5.4 Dashboard, sync on-demand y vista de errores
5.5 Que significa que el sistema sea propio

## Parte III - Operacion, costos y nuevo oficio
...
6.4 Por que no hay operacion sin diagnostico
...
8.3 Capturar conocimiento
8.4 Decidir buy, build o reemplazo parcial
8.5 Conclusiones
