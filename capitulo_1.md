...
**Decisión pendiente**: Antes de publicar, decidir si mantener nombres reales como [Shopify], [n8n] y [Max Planck Dev], o anonimizarlos como "plataforma de e-commerce X", "herramienta low-code Y" y "agencia de desarrollo Z". Requiere evaluación de permisos de marca y privacidad.

**Tabla comparativa de enfoques** (basada en evidencia del caso):

| Criterio | ETL Tradicional | Low-Code (ej. n8n) | Agentes de IA |
|----------|-----------------|-------------------|---------------|
