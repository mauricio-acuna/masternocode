...
En el caso, el síntoma era claro: había que sincronizar 8.000 productos desde cinco proveedores hacia Shopify vía Modern Dropship. Pero el cuello de botella no era simplemente mover datos. Era mover datos con traducción, normalización, manejo de errores, visibilidad, bajo costo y autonomía operativa.

Si el problema se definía como "hacer un ETL", el vendor parecía razonable. Si se definía como "armar flujos visuales", n8n parecía razonable. Si se definía como "construir una capacidad propia y observable", la solución necesitaba otra arquitectura.
...
En el ETL tradicional, el conocimiento vivía dentro del vendor. En n8n, parte del conocimiento vivía en flujos, nodos y ajustes frágiles. En el enfoque con agentes, el conocimiento se convirtió en una knowledge base, una interfaz de onboarding y una configuración estructurada.
...
**Evidencia del caso**: La comparación de la diapositiva 14 muestra tres enfoques lado a lado: ETL tradicional, n8n y agentes de IA. Compara tiempo, costo recurrente, visibilidad, mantenimiento y escala.
...
**Decisión pendiente**: Antes de publicar, revisar claims como "costo operativo -70%" o "el vendor deja de ser necesario". En borrador pueden funcionar como provocación comercial basada en la diapositiva, pero en versión pública conviene contextualizarlos como hipótesis u oportunidades sujetas a validación.
